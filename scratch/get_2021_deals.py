...
# Filter for 2021 deals
df_2021 = antonio_df[antonio_df['Year'] == 2021].copy()

# Sort by Win date
df_2021 = df_2021.sort_values('Win date')

print(f"=== LISTA DE LOS {len(df_2021)} COMERCIOS GANADOS EN 2021 ===")
print("==================================================")

for idx, row in df_2021.iterrows():
    name = row['Nodo Name']
    # Check if win_date is timestamp or string or nan
